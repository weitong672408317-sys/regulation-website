                ...
                <table className="w-full text-base min-w-[800px] bg-white">
                  <thead>
                    <tr className="bg-[#E8EDF5]">
                      ...
                      <th className="px-4 py-4 text-left font-bold text-[#2E3F73] border-b-2 border-r border-[#D8DDED] w-[25%]">适用对象 / 范围</th>
                      <th className="px-4 py-4 text-left font-bold text-[#2E3F73] border-b-2 border-r border-[#D8DDED] w-[35%]">税率</th>
                      <th className="px-4 py-4 text-left font-bold text-[#2E3F73] border-b-2 border-[#D8DDED] w-[25%]">注册要求及门槛</th>
                    </tr>
                  </thead>
                  <tbody>
