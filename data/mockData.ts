...
const fallbackCountries: CountryData[] = [
  ...
  },
  {
    ...
    regulatorySystem: {
      overview: '核心特征\n\n马来西亚对烟草及相关吸烟产品采取分层监管。Act 852覆盖烟草产品、吸烟物质和替代烟草产品的注册、广告、销售和购买控制等事项。传统烟草和HNB烟支仍有合法市场空间；电子烟已被纳入Act 852管理；含尼古丁电子烟受到液体/凝胶尼古丁毒物管制影响，普通商业上市路径明显受阻；尼古丁袋、尼古丁口含膜等口含类尼古丁产品尚未形成清晰、稳定的专门分类。\n\n传统烟草\n\n传统卷烟、雪茄、烟丝及其他制成烟草属于可准入但强监管产品。马来西亚对传统烟草的监管重点，是在保留合法市场的同时，通过税务、包装警示、销售限制、广告禁令和禁烟场所规则控制消费扩张。\n\nHNB烟支/加热烟草产品\n\nHNB烟支属于含烟草的加热产品，监管定位更接近传统烟草。马来西亚法规和税务文件已单独出现"加热产品/加热烟草产品"安排，说明HNB烟支具备独立监管位置，并未与含尼古丁电子烟混同处理。\n\n含尼古丁电子烟\n\n含尼古丁电子烟是当前风险最高的品类。2026年液体尼古丁判决后，电子烟用液体/凝胶尼古丁继续涉及《毒药法》管制。含尼古丁电子烟液、含尼古丁烟弹和一次性含尼古丁电子烟，需要先解决毒物或药剂路径下的产品上市和供应资格问题，普通电子烟零售、电商、分销和商业推广路径缺乏稳定依据。\n\n不含尼古丁电子烟及电子烟设备\n\n不含尼古丁电子烟和电子烟设备不受液体尼古丁判决直接影响，但仍属于Act 852的吸烟产品监管范围。该类产品不能按普通电子消费品理解，销售、推广和渠道仍受控烟规则约束。\n\n尼古丁袋/尼古丁口含膜\n\n尼古丁袋、尼古丁口含膜、口含烟等产品尚未形成清晰专门分类。含烟草产品更接近烟草产品监管；不含烟草但含尼古丁的口含产品，更容易触发毒物或药剂监管。该类产品目前不适合直接按已开放的新型烟草品类理解。\n\n监管部门\n\n马来西亚烟草及相关吸烟产品监管主要由卫生监管、药剂/毒物监管、税务海关和地方许可共同执行：\n\n• 马来西亚卫生部：负责产品注册、包装标签、销售控制、广告促销限制、禁烟场所、未成年人保护及Act 852执法。\n• 药剂执法司：负责药品、传统药品、化妆品和毒物相关执法，覆盖注册/通报、供应链、销售、广告和使用环节。\n• 毒药委员会：就毒物分类、毒物清单调整等事项向卫生部长提供意见。\n• 马来西亚财政部：负责烟草相关税收政策。\n• 马来西亚海关局：负责进口申报、税收征管和边境执法。\n• 地方政府/地方主管机关：负责营业执照、零售场所许可和地方执法。',
      definition: '1. 吸烟产品\n\nAct 852使用"吸烟产品"作为上位概念，覆盖烟草产品、吸烟物质和替代烟草产品。烟草、电子烟液、电子烟设备及其他相关产品，需先判断是否落入该框架。\n\n2. 烟草产品\n\nAct 852将"烟草产品"定义为经加工烟草，或任何含有烟草并设计供人消费的产品。传统卷烟、雪茄、烟丝、其他制成烟草，以及含烟草的HNB烟支，通常属于烟草产品。\n\n3. 吸烟物质\n\nAct 852将"吸烟物质"定义为用于吸烟的任何物质或物质组合，包括尼古丁、丙二醇、甘油和三甘醇。电子烟液、含尼古丁电子烟液、补充液、烟弹内液体及一次性电子烟内液体，通常按吸烟物质判断。\n\n4. 替代烟草产品\n\nAct 852将"替代烟草产品"定义为烟草产品以外、能够被吸食的产品，无论是否与吸烟物质一同使用。电子烟设备、电子雾化设备、电子烟组件及其他用于产生或配合吸入气雾的装置，通常按替代烟草产品或相关组件判断。\n\n5. 尼古丁袋/尼古丁口含膜\n\n马来西亚现行公开法规未见对尼古丁袋、尼古丁口含膜设置清晰、专门定义。该类产品按成分和形态判断：含烟草的按烟草产品判断；不含烟草但含尼古丁、且为口含或口腔使用形态的，重点按《毒药法》及药剂监管路径判断。\n\n6. 烟草薄片、烟叶、爆珠/香精胶囊、滤嘴棒\n\n马来西亚现行公开法规未见对烟草薄片、烟叶、爆珠、香精胶囊、滤嘴棒设置统一、专门定义。该类产品按成分和形态判断：含烟草或由烟草加工形成的，可能落入烟草产品或烟草原料相关监管；不含烟草、不含尼古丁的爆珠、香精胶囊、滤嘴棒，公开资料未见其本身被单独定义为吸烟产品。'
    },
    accessRestrictions: {
      electronicCigarette: {
    ...
    compliance: {
      licenseRequirements: '马来西亚烟草及相关吸烟产品的资质重点，不在于普通公司营业执照，而在于是否需要完成吸烟产品注册、是否涉及毒物/药剂批准，以及产品是否具有普通商业上市基础。',
      table: [
        {
          product: '传统卷烟、雪茄、烟丝',
          nppbkc: '需要向卫生总监提交资料，完成烟草产品注册',
          piImportApproval: '不适用',
          bpomRegistration: '',
          halalCertification: ''
        },
        {
          product: 'HNB烟支/加热烟草产品',
          nppbkc: '需要向卫生总监提交资料，完成烟草产品注册',
          piImportApproval: '不适用',
          bpomRegistration: '',
          halalCertification: ''
        ...
        {
          product: 'HNB加热设备',
          nppbkc: '以加热烟草使用为设计目的的设备，倾向于纳入替代烟草产品或吸烟产品相关组件管理，应向卫生总监提交资料并完成相应注册',
          piImportApproval: '不适用',
          bpomRegistration: '',
          halalCertification: ''
        },
        {
          product: '含尼古丁电子烟',
          nppbkc: '无普通商业上市路径。含尼古丁电子烟液、烟弹、一次性电子烟等产品，不能通过吸烟产品注册直接进入普通商业销售渠道',
          piImportApproval: '液体/凝胶尼古丁继续涉及《毒药法》管制；消费型含尼古丁电子烟通常难以取得药品/制剂注册或主管机关批准',
          bpomRegistration: '',
          halalCertification: ''
        },
        {
          product: '不含尼古丁电子烟',
          nppbkc: '需要向卫生总监提交资料，完成吸烟产品注册；其中电子烟液按吸烟物质注册，电子烟设备按替代烟草产品或吸烟产品相关组件注册',
          piImportApproval: '不适用',
          bpomRegistration: '',
          halalCertification: ''
        },
        {
          product: '尼古丁袋/尼古丁口含膜',
          nppbkc: '含烟草的，需向卫生总监提交资料，完成烟草产品注册；不含烟草但含尼古丁且为口含形态的，公开资料未见稳定吸烟产品注册路径',
          piImportApproval: '不含烟草但含尼古丁的，普通商业上市基础不清晰，通常需先满足毒物/药剂监管要求',
          bpomRegistration: '',
          halalCertification: ''
        },
        {
          product: '烟草薄片、烟叶',
          nppbkc: '保持烟草原料形态的，公开资料未见单独吸烟产品注册要求；已加工、包装或设计供人消费的，需向卫生总监提交资料并完成烟草产品注册',
          piImportApproval: '不适用',
          bpomRegistration: '',
          halalCertification: ''
        },
        {
          product: '爆珠/香精胶囊、滤嘴棒',
          nppbkc: '不含烟草、不含尼古丁的，公开资料未见吸烟产品注册要求；含烟草、尼古丁、烟草提取物或液体/凝胶成分的，需按成分确认是否需要烟草产品注册、吸烟物质注册或替代烟草产品注册',
          piImportApproval: '不含尼古丁的，不适用；含尼古丁的，通常需先满足毒物/药剂监管要求',
          bpomRegistration: '',
          halalCertification: ''
        }
      ],
