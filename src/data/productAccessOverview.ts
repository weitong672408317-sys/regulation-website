  ...
  groups: [
    {
      ...
      products: [
        ...
        { productName: '烟草原料：烟草薄片、烟叶', targetId: 'product-tobacco-sheet' },
        { productName: '不含尼古丁、烟草成分或烟草提取物的爆珠、香精胶囊、滤嘴棒等普通辅材', targetId: 'product-bead' },
      ],
    },
    {
      status: '部分限制 / 监管要求不明确',
  ...
  groups: [
    {
      ...
      statusType: 'green',
      products: [
        { productName: '传统烟草产品 / 烟草基产品：传统卷烟、雪茄、烟丝、加工烟草及其他烟草基产品', targetId: 'product-traditional-tobacco' },
        { productName: '电子烟及雾化产品：电子烟设备、雾化器、烟油 / 电子烟液 / 补充液、烟弹 / 预灌装产品、电子雾化相关配件和耗材', targetId: 'product-ecig' },
        ...
        { productName: '烟草原料 / 半成品：烟草薄片、烟叶及其他烟草原料', targetId: 'product-tobacco-raw' },
