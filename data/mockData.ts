...
const fallbackCountries: CountryData[] = [
  ...
  references: {
    regulations: [
      ...
      {
        title: '《消费税法》（1995年第11号法，经2007年第39号法修订）——规定烟草制品作为应税消费品缴纳消费税并使用税票',
        url: ''
      },
      {
        title: '财政部烟草制品消费税相关部长规章——细化烟草制品、电子烟、HPTL等产品的税率、最低零售价、纳税和税票程序',
        url: ''
      },
      {
        title: '地方性无烟区 / 控烟条例——规定地方无烟区、禁售区域、展示和执法要求，部分地区可能严于中央规则',
        url: ''
      }
    ],
    news: [
