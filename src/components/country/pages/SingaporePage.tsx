        ...
        cards={[
          {
            ...
            content: (
              <>
                <p className="text-base leading-7 text-[#334155] text-justify mb-4">新加坡采取&ldquo;传统烟草产品从严管控、新型烟草及尼古丁产品明确禁入、烟草使用空间高度受限&rdquo;的监管模式。</p>
                <BulletList items={[
      ...
      <TaxSection>
        ...
        <TaxTableCard title="3. GST">
          <div className="space-y-2">
            <div className="flex items-start gap-2">
              <span className="mt-[9px] w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
              <span className="text-[#334155] text-base leading-7 text-justify flex-1 min-w-0">新加坡现行 GST 税率为 9%。</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="mt-[9px] w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
              <span className="text-[#334155] text-base leading-7 text-justify flex-1 min-w-0">传统烟草产品在新加坡本地销售通常需缴纳 GST；进口烟草产品也需在进口环节缴纳 GST，计税基础通常包括货物价值、保险费、运费，以及适用的关税和消费税。</span>
            </div>
          </div>
        </TaxTableCard>
      </TaxSection>
