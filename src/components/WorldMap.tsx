...
const countryDataMap: Record<string, any> = {
  ...
  'Singapore': { labelPos: [107, 5], countryCenter: [103.8, 1.35], name: '新加坡', id: 'singapore', isoCode: 'SG', intensity: '极高' },
  'Malaysia': { labelPos: [96, 8], countryCenter: [101.9758, 4.2105], name: '马来西亚', id: 'malaysia', isoCode: 'MY', intensity: '高' },
