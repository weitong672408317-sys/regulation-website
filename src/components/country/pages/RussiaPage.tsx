          ...
          {country.compliance.licenseCards && country.compliance.licenseCards.length > 0 ? (
            <>
              {country.compliance.licenseRequirements && (
                <p className="text-[#334155] mb-6">{country.compliance.licenseRequirements}</p>
              )}
            ...
            <p className="text-[#334155]">{country.compliance.licenseRequirements}</p>
          ) : null}
        </div>
      </section>
              ...
              <ul className="space-y-2">
                {country.trendsWarnings.redLines.map((line, index) => (
                  <li key={index} className="flex items-start gap-3">
                    ...
                    <span className="text-[#334155] leading-relaxed">{line}</span>
                  </li>
                ))}
              </ul>
            </div>
