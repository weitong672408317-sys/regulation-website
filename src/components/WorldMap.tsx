...
const countryDataMap: Record<string, any> = {
  ...
  'Singapore': { labelPos: [110, 5], countryCenter: [103.8, 1.35], name: '新加坡', id: 'singapore', isoCode: 'SG', intensity: '极高' },
  'Malaysia': { labelPos: [92, 12], countryCenter: [101.69, 3.14], name: '马来西亚', id: 'malaysia', isoCode: 'MY', intensity: '高' },
