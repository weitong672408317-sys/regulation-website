...
export default function ParaguayPage(_props: ParaguayPageProps) {
  return (
    <>
      ...
      <section className="mb-8">
        <div className="bg-white border border-[#D4DAEA] rounded-2xl shadow-sm p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
              <h3 className="text-lg font-bold text-[#2E3F73] mb-4">1. 传统烟草产品/烟草基产品</h3>
              <div className="mb-4">
              ...
              <div className="bg-white border border-[#E2E6EF] border-l-2 border-l-[#6AAF7C] rounded-xl p-4 shadow-sm">
                ...
                <div className="font-bold text-[#263247] text-base mb-2">传统卷烟、雪茄、烟丝、加工烟草及其他烟草基产品</div>
                <div className="text-[#334155] text-base leading-7">
                  ...
                  <ul className="space-y-1 text-[#334155]">
                    <li className="flex items-start gap-2">
                      ...
                      <span>烟草基产品进入巴拉圭市场，应办理 DINAVISA 产品登记，登记结果体现为烟草产品证书或按品种产品登记证明。</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                      <span>从事烟草、烟草产品或烟草产品原料制造、进口、出口的主体，应办理 DINAVISA 烟草主体登记。</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                      <span>普通零售端未见单独烟草零售许可证要求，但销售行为仍需遵守未成年人保护、包装警示、广告限制、公共场所使用限制和税务规则。</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                      <span>公开资料下未见传统卷烟、雪茄、烟丝、加工烟草等烟草基产品的全国性全面禁售规则。</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
              <h3 className="text-lg font-bold text-[#2E3F73] mb-4">2. 电子烟及雾化产品</h3>
              <div className="mb-4">
                <div className="inline-flex px-2 py-0.5 rounded bg-[#E8EDF5] text-[#2E3F73] text-sm font-semibold mb-3">产品定性</div>
              ...
              <div className="bg-white border border-[#E2E6EF] border-l-2 border-l-[#6AAF7C] rounded-xl p-4 shadow-sm">
                ...
                <div className="font-bold text-[#263247] text-base mb-2">电子烟、雾化器、烟油/补充液、相关配件和耗材</div>
                <div className="text-[#334155] text-base leading-7">
                  ...
                  <ul className="space-y-1 text-[#334155]">
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                      <span>电子烟及雾化相关产品进入巴拉圭市场，应完成 DINAVISA 产品注册。</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                      <span>从事该类产品进口、出口、生产、分销、仓储或销售的主体及其经营场所，还需取得 DINAVISA 授权。</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                      <span>用于雾化吸入的物质，即使不含尼古丁，也应纳入注册、标签和税务合规范围。</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                      <span>含尼古丁雾化液应符合尼古丁浓度、成分资料、标签警示、未成年人保护和销售渠道限制要求。</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
              <h3 className="text-lg font-bold text-[#2E3F73] mb-4">3. HNB烟支及加热装置</h3>
              <div className="mb-4">
                <div className="inline-flex px-2 py-0.5 rounded bg-[#E8EDF5] text-[#2E3F73] text-sm font-semibold mb-3">产品定性</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white border border-[#E2E6EF] border-l-2 border-l-[#6AAF7C] rounded-xl p-4 shadow-sm">
                  ...
                  <div className="font-bold text-[#263247] text-base mb-2">HNB烟支/加热烟草棒</div>
                  <div className="text-[#334155] text-base leading-7">
                    <ul className="space-y-1 text-[#334155]">
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                        <span>含烟草材料的 HNB烟支/加热烟草棒，应按烟草基产品路径办理 DINAVISA 产品登记。</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                        <span>从事HNB烟支/加热烟草棒制造、进口、出口的主体，应办理 DINAVISA 烟草主体登记。</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                        <span>该类产品进入市场后，应遵守包装警示、销售限制、公共场所使用限制、广告限制和 ISC 税务规则。</span>
                      </li>
                    </ul>
                  </div>
                </div>
                <div className="bg-white border border-[#E2E6EF] border-l-2 border-l-[#6AAF7C] rounded-xl p-4 shadow-sm">
                  ...
                  <div className="font-bold text-[#263247] text-base mb-2">HNB设备/加热装置及相关配件</div>
                  <div className="text-[#334155] text-base leading-7">
                    <ul className="space-y-1 text-[#334155]">
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                        <span>HNB设备本身不含烟草材料，原则上不按烟草基产品登记。</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                        <span>HNB设备可纳入《第7508/2025号法》关于新兴装置、相关设备、配件和耗材的监管范围；进入市场前，应按该路径办理 DINAVISA 产品注册。</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                        <span>从事 HNB设备及相关电子装置进口、出口、生产、分销、仓储或销售的主体及其经营场所，还需取得 DINAVISA 授权。</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
              <h3 className="text-lg font-bold text-[#2E3F73] mb-4">4. 口含、鼻吸及其他非燃烧型产品</h3>
              <div className="mb-4">
                <div className="inline-flex px-2 py-0.5 rounded bg-[#E8EDF5] text-[#2E3F73] text-sm font-semibold mb-3">产品定性</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-white border border-[#E2E6EF] border-l-2 border-l-[#C9A24C] rounded-xl p-4 shadow-sm">
                  ...
                  <div className="font-bold text-[#263247] text-base mb-2">尼古丁袋</div>
                  <div className="text-[#334155] text-base leading-7">
                    <div className="mb-3">
                      ...
                      <ul className="space-y-1 text-[#334155]">
                        <li className="flex items-start gap-2">
                          ...
                          <span>DINAVISA 曾发布 Bolsas de Nicotina（尼古丁袋）专项注册草案。草案将尼古丁袋定义为不含烟草的可消费单位，含有尼古丁、香料、水、有机纤维素和填充剂，拟放入口腔中，使尼古丁通过口腔黏膜吸收。</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
                          <span>草案正文明确适用于无治疗目的的尼古丁袋；如产品被宣传为尼古丁替代治疗或具有治疗目的，应适用药品或医疗器械监管规则。</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
                          <span>该草案尚未正式落地，不能直接等同于现行稳定准入规则。</span>
                        </li>
                      </ul>
                    </div>
                    <div className="mb-3">
                      <div className="font-semibold text-[#263247] mb-1">DNIT 归类口径</div>
                      <ul className="space-y-1 text-[#334155]">
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
                          <span>DNIT 已将"无烟草尼古丁袋"纳入商品归类查询 / 裁定资料中，说明该类产品在进口申报时已有海关税则归类口径。</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
                          <span>该口径仅用于 HS 编码 / 税号和进口税费申报，不等于取得 DINAVISA 卫生注册，也不等于产品已经形成稳定上市路径。</span>
                        </li>
                      </ul>
                    </div>
                    <div>
                      <div className="font-semibold text-[#263247] mb-1">准入结论</div>
                      <ul className="space-y-1 text-[#334155]">
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
                          <span>尼古丁袋进入市场前，仍需确认 DINAVISA 卫生注册、标签、尼古丁含量、主体 / 场所授权、商品归类和税务申报口径。</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className="bg-white border border-[#E2E6EF] border-l-2 border-l-[#C9A24C] rounded-xl p-4 shadow-sm">
                  ...
                  <div className="font-bold text-[#263247] text-base mb-2">其他无烟草口含型尼古丁产品</div>
                  <div className="text-[#334155] text-base leading-7">
                    <ul className="space-y-1 text-[#334155]">
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
                        <span>巴拉圭公开法规尚未见对尼古丁片、尼古丁含片、尼古丁口含膜、尼古丁粉末袋等产品设置单独、明确、成熟的定义或准入路径。</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
                        <span>进入市场前，应按产品形态、成分、使用方式和标签表达，确认卫生注册、标签、尼古丁含量、商品归类和税务申报要求。</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="bg-white border border-[#E2E6EF] border-l-2 border-l-[#C9A24C] rounded-xl p-4 shadow-sm">
                  ...
                  <div className="font-bold text-[#263247] text-base mb-2">非燃烧型烟草产品</div>
                  <div className="text-[#334155] text-base leading-7">
                    <ul className="space-y-1 text-[#334155]">
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
                        <span>嚼烟、鼻烟等含烟草材料的非燃烧型烟草产品，应按烟草产品 / 烟草基产品口径判断。</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
                        <span>该类产品进入市场时，应关注 DINAVISA 烟草基产品登记、烟草主体登记、包装警示、销售限制、广告限制和 ISC 税务规则。</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
                        <span>如产品同时外加尼古丁，或采用袋状、片状、粉末状等新型口腔使用形态，应结合产品成分和使用方式进一步确认注册、标签和税务要求。</span>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
              <h3 className="text-lg font-bold text-[#2E3F73] mb-4">5. 烟草原料及普通辅材</h3>
              <div className="mb-4">
                <div className="inline-flex px-2 py-0.5 rounded bg-[#E8EDF5] text-[#2E3F73] text-sm font-semibold mb-3">产品定性</div>
              ...
              <div className="bg-white border border-[#E2E6EF] border-l-2 border-l-[#6AAF7C] rounded-xl p-4 shadow-sm">
                ...
                <div className="font-bold text-[#263247] text-base mb-2">烟草薄片、烟叶、爆珠/香精胶囊、滤嘴棒</div>
                <div className="text-[#334155] text-base leading-7">
                  <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                  <ul className="space-y-1 text-[#334155]">
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                      <span>烟草薄片、烟叶作为烟草原料或半成品可准入，重点适用进口申报、税务和下游用途规则。</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                      <span>涉及烟草产品原料制造、进口、出口的主体，应办理 DINAVISA 烟草主体登记。</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                      <span>爆珠、香精胶囊、滤嘴棒作为普通烟草辅材可准入；不含尼古丁、不含烟草提取物、也不作为雾化耗材销售的，通常不按电子烟及雾化产品注册。</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                      <span>如相关辅材含尼古丁、烟草提取物，或作为雾化液、烟弹、胶囊、HNB设备配件等产品的一部分进入市场，应转入对应烟草基产品、电子烟及雾化产品或 HNB设备路径判断。</span>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="pb-6">
            ...
            <div className="bg-[#E8EDF5] border border-[#D8DDED] rounded-lg p-4 mb-6">
              <p className="text-sm text-[#64748B] leading-7">
                以下链接主要为官方公布文本、主管机关公开页面或官方信息公告。巴拉圭相关法律、决议和主管机关口径可能经过后续修订或更新，具体适用应以现行有效文本、后续修正和主管机关最新口径为准。
              </p>
            </div>

            <div className="space-y-4">
              <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
                <h4 className="font-bold text-[#2E3F73] text-lg mb-4">烟草控制与无烟环境规则</h4>
                <div className="space-y-4">
                  <div>
                    <a href="https://www.bacn.gov.py/leyes-paraguayas/4519/ley-n-5538-modifica-la-ley-n-404510-que-modifica-la-ley-n-12591-modificada-por-la-ley-n-242104-sobre-su-regimen-tributario-que-regula-las-actividades-relacionadas-al-tabaco-y-establece-medidas-sanitarias-de-proteccion-a-la-poblacion" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base mb-2 hover:underline block">《第5538/2015号法：关于修改第4045/2010号法并规制烟草相关活动及公共健康保护措施的法律》</a>
                    <p className="text-sm text-[#334155] leading-6">巴拉圭传统烟草控制基础法，主要覆盖无烟环境、烟草广告促销和赞助、包装标签、销售限制、烟草产品内容物和释放物监管。</p>
                  </div>
                  <div className="pt-4 border-t border-[#D8DDED]">
                    <a href="https://dinavisa.gov.py/wp-content/uploads/2025/08/DECRETO-N%C2%B0-7605-2017-Regula-las-actividades-relacionadas-al-tabaco.pdf" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base mb-2 hover:underline block">《第7605/2017号法令：关于实施第5538/2015号法若干条款的法令》</a>
                    <p className="text-sm text-[#334155] leading-6">第5538/2015号法的主要实施法令，细化烟草包装健康警示、无烟环境、广告促销、销售限制和监管执行等要求。</p>
                  </div>
                  <div className="pt-4 border-t border-[#D8DDED]">
                    <a href="https://assets.tobaccocontrollaws.org/uploads/legislation/Paraguay/Paraguay-Decree-No.-46242020-native.pdf" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base mb-2 hover:underline block">《第4624/2020号法令：关于修改第7605/2017号法令第3条的法令》</a>
                    <p className="text-sm text-[#334155] leading-6">无烟环境规则的重要修订文件，将公共空间使用限制扩展至烟草产品、加热烟草产品以及含或不含尼古丁的电子烟。</p>
                  </div>
                </div>
              </div>

              <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
                <h4 className="font-bold text-[#2E3F73] text-lg mb-4">电子烟、雾化产品与新兴装置规则</h4>
                <div className="space-y-4">
                  <div>
                    <a href="https://www.bacn.gov.py/leyes-paraguayas/12907/ley-n-7508-2025-que-establece-medidas-sanitarias-de-protecci-n-a-la-salud-de-las-personas-en-relaci-n-a-los-dispositivos-accesorios-e-insumos-de-los-sistemas-electr-nicos-de-administraci-n-de-nicotina-sean-y-sistemas-similares-sin-nicotina-sssn-u-otros-dispositivos-nuevos-y-emergentes-con-o-sin-nicotina-y-sustancias-utilizadas-para-el-vapeo" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base mb-2 hover:underline block">《第7508/2025号法：关于电子尼古丁输送系统、无尼古丁类似系统、新兴装置、配件、耗材和用于雾化物质的健康保护措施》</a>
                    <p className="text-sm text-[#334155] leading-6">当前电子烟、雾化器、新兴装置、配件、耗材和用于雾化物质的核心专项法，覆盖进口、生产、消费、广告和商业化，并对销售、陈列、未成年人保护、尼古丁浓度和广告促销设置专项规则。</p>
                  </div>
                  <div className="pt-4 border-t border-[#D8DDED]">
                    <a href="https://www.mspbs.gov.py/dependencias/dnvs/adjunto/843cb0-ResolucionDNVSN1531.pdf" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base mb-2 hover:underline block">《国家卫生监督局第153/2021号决议：关于电子烟、雾化器、电子尼古丁输送系统、无尼古丁类似系统及相关使用物质的产品登记和经营场所授权要求的决议》</a>
                    <p className="text-sm text-[#334155] leading-6">电子烟及相关产品的注册和经营场所授权规则，涉及产品登记、进口、出口、生产、分销和商业化场所授权。第7508/2025号法出台后，该决议未见被明文废止，仍可作为登记/授权程序依据；具体适用应与第7508/2025号法项下的新监管要求一并判断。</p>
                  </div>
                </div>
              </div>

              <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
                <h4 className="font-bold text-[#2E3F73] text-lg mb-4">DINAVISA 注册与产品资料</h4>
                <div className="space-y-4">
                  <div>
                    <a href="https://dinavisa.gov.py/productos-a-base-de-tabaco-tb/" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base mb-2 hover:underline block">DINAVISA：烟草基产品（Productos a Base de Tabaco – TB）</a>
                    <p className="text-sm text-[#334155] leading-6">DINAVISA 烟草基产品登记页面，列明烟草基产品相关登记资料和 CPT（Certificado de Producto de Tabaco，烟草产品证书）等要求。</p>
                  </div>
                  <div className="pt-4 border-t border-[#D8DDED]">
                    <a href="https://dinavisa.gov.py/wp-content/uploads/2024/04/Proyecto-de-Resolucion-Bolsas-de-Nicotina.docx" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base mb-2 hover:underline block">DINAVISA：尼古丁袋专项注册规则草案</a>
                    <p className="text-sm text-[#334155] leading-6">DINAVISA 曾发布 Bolsas de Nicotina（尼古丁袋）专项注册草案。该草案尚未正式落地，但对尼古丁袋的产品定义、注册思路和非治疗用途边界具有参考价值。</p>
                  </div>
                </div>
              </div>

              <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
                <h4 className="font-bold text-[#2E3F73] text-lg mb-4">税务与商品归类资料</h4>
                <div>
                  <a href="https://www.dnit.gov.py/web/portal-institucional/dictamenes-de-clasificacion" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base mb-2 hover:underline block">DNIT：商品归类数据库</a>
                  <p className="text-sm text-[#334155] leading-6">用于查询巴拉圭商品归类 / 裁定资料，可辅助确认尼古丁袋、电子烟、雾化产品、烟草原料及相关配件的 HS 编码和进口税务申报口径。</p>
                </div>
              </div>
            </div>
          </div>

          <div className="pt-6 border-t border-[#D8DDED]">
            <h3 className="text-lg font-bold text-[#2E3F73] mb-4">新闻 / 执法动态</h3>
            <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
              <div className="space-y-4">
                <div>
                  <a href="https://dinavisa.gov.py/alerta-sanitaria-n-12-2023/" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base mb-2 hover:underline block">DINAVISA：未注册电子烟产品卫生警示</a>
                  <p className="text-sm text-[#334155] leading-6">DINAVISA 针对未注册或来源不明电子烟产品发布卫生警示，体现主管机关对电子烟产品注册、来源可追溯和授权销售场所的监管关注。</p>
                </div>
                <div className="pt-4 border-t border-[#D8DDED]">
                  <a href="https://www.mspbs.gov.py/portal/25515/exigiran-inscripcion-de-cigarrillos-electronicos-y-vapeadores-para-su-importacion.html" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base mb-2 hover:underline block">MSPBS：电子烟和雾化器进口登记要求说明</a>
                  <p className="text-sm text-[#334155] leading-6">公共卫生和社会福利部说明电子烟、vapeadores、vaporeadores、SEAN、SSSN 及相关使用物质需要办理 DINAVISA 登记，体现电子烟进口前注册要求。</p>
                </div>
                <div className="pt-4 border-t border-[#D8DDED]">
                  <a href="https://www.vouga.com.py/novedades-impositivas-agosto-2025/" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base mb-2 hover:underline block">Vouga Abogados：2025年税务动态</a>
                  <p className="text-sm text-[#334155] leading-6">说明《第7508/2025号法》对电子烟、雾化器及其可雾化液体选择性消费税（ISC）口径的影响。</p>
                </div>
              </div>
            </div>
          </div>
