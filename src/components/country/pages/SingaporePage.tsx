  ...
  return (
    <CountryPageTemplate>
        ...
        cards={[
          {
            ...
            content: (
              <>
                <p className="text-base leading-7 text-[#334155] mb-4">新加坡采取&ldquo;传统烟草产品从严管控、新型烟草及尼古丁产品明确禁入、烟草使用空间高度受限&rdquo;的监管模式。</p>
                <BulletList items={[
        ...
        <ProductModuleCard title="1. 传统烟草产品及烟草材料" label="产品定性">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            <StatusCard
              ...
              title="1.1 传统烟草成品"
              content={<>
                <div className="text-base text-[#334155] mb-2">适用产品：传统卷烟、雪茄、小雪茄、其他制成烟草等。</div>
            ...
            <StatusCard
              ...
              title="1.2 烟草材料 / 原料"
              content={<>
                <div className="text-base text-[#334155] mb-2">适用产品：未加工烟草、切丝烟草、烟草废料、烟叶、烟草薄片等。</div>
                <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                <ul className="space-y-1 text-[#334155]">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
          ...
          <StatusCard
            ...
            title="1.3 水烟烟草"
            content={<>
              <div className="text-base text-[#334155] mb-2">适用产品：shisha tobacco、shisha molasses / tobacco（水烟烟草、水烟糖蜜 / 烟草）。</div>
              <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
              <ul className="space-y-1 text-[#334155]">
                <li className="flex items-start gap-2">
        ...
        <ProductModuleCard title="2. 新型烟草、尼古丁及其他禁止类产品" label="产品定性">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <StatusCard
              ...
              content={<>
                <div className="text-base text-[#334155] mb-2">适用产品：HNB烟支、加热烟草产品、加热设备、电子烟、雾化器、烟油、烟弹、补充液及相关组件。</div>
                <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                <ul className="space-y-1 text-[#334155]">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#DC6B6B] mt-1.5 flex-shrink-0"></span>
            ...
            <StatusCard
              ...
              content={<>
                <div className="text-base text-[#334155] mb-2">适用产品：尼古丁袋、尼古丁口含膜、口含烟、鼻烟、snus、可溶性烟草或尼古丁、嚼烟，以及 Gutkha、Khaini、Zarda 等南亚常见口含 / 咀嚼类烟草制品。</div>
            ...
            <StatusCard
              ...
              title="2.3 仿烟产品及相关组件"
              content={<>
                <div className="text-base text-[#334155] mb-2">适用产品：模仿烟草产品、电子烟或吸烟行为的产品、装置、食品或相关组件。</div>
                <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                <ul className="space-y-1 text-[#334155]">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#DC6B6B] mt-1.5 flex-shrink-0"></span>
        ...
        <ProductModuleCard title="3. 爆珠、香精胶囊、滤嘴棒等辅料" label="产品定性">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <StatusCard
              ...
              title="3.1 爆珠、香精胶囊"
              content={<>
                <div className="text-base text-[#334155] mb-2">适用产品：爆珠、香精胶囊。</div>
                <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                <ul className="space-y-1 text-[#334155]">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
            ...
            <StatusCard
              ...
              content={<>
                <div className="text-base text-[#334155] mb-2">适用产品：滤嘴棒等不含烟草、不含尼古丁的辅料。</div>
                <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                <ul className="space-y-1 text-[#334155]">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
      ...
      <ComplianceSection country={country}>
        <p className="text-[#334155] text-base leading-7 mb-6">新加坡烟草产品合规资质主要集中在 HSA 烟草许可证和特定禁止类产品的有限豁免安排。传统烟草产品存在许可经营路径，但许可证按经营环节和具体门店管理；禁止类产品只有在法规明确列明的特定产品、行为和目的下，才可能适用有限豁免。</p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
            ...
            <div className="ml-9 space-y-2">
              <div className="flex items-start gap-2">
                ...
                <span className="text-[#334155] text-base leading-6">适用于进口、批发和分销传统烟草产品的经营活动。</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-6">进口、批发或分销烟草产品前，应取得 HSA 烟草进口商和批发商许可证。</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-6">申请通常需要提交经营主体、仓库或办公场所、生产商授权等资料，许可管理与具体经营安排相关。</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
            ...
            <div className="ml-9 space-y-2">
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-6">适用于在新加坡本地零售传统烟草产品的门店。</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-6">烟草零售许可证按具体门店发放，经营多个门店的，应分别申请。</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-6">零售许可证不得在不同公司或不同门店之间转让。</span>
              </div>
            </div>
          </div>
        </div>

        <div className="mt-4 bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
          <div className="flex items-start gap-3 mb-4">
          ...
          <div className="ml-9 space-y-2">
            <div className="flex items-start gap-2">
              <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
              <span className="text-[#334155] text-base leading-6">新加坡法规对部分禁止类产品设有有限豁免，涉及部分 smokeless tobacco product（无烟烟草产品）、vaporiser solution（雾化器溶液）、vaporiser（雾化器）、exempt imitation tobacco product（豁免仿烟产品）及其组件。</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
              <span className="text-[#334155] text-base leading-6">法规列明的豁免目的包括 non-clinical research（非临床研究）、product development（产品开发）和 supply-chain related activity（供应链相关活动）。</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
              <span className="text-[#334155] text-base leading-6">supply-chain related activity（供应链相关活动）在法规中指产品及组件的移动和储存，包括组件采购、供应商管理、生产排期、库存和仓库管理、进出口贸易合规、分销及相关支持活动。</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
              <span className="text-[#334155] text-base leading-6">上述供应链相关活动只是在豁免令下用于判断&ldquo;豁免目的&rdquo;的范围。相关产品是否可以进口、持有、移动或储存，还需要继续满足豁免令对产品类型、行为类型、主体、通知、记录、储存和期限等条件的要求。</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
              <span className="text-[#334155] text-base leading-6">该等豁免不等同于新加坡本地消费市场准入，不能作为本地销售、递样、展示、推广或消费者使用的依据。</span>
            </div>
          </div>
        </div>
      </ComplianceSection>
      ...
      <TaxSection>
        <TaxTableCard title="1. 烟草消费税">
          <p className="text-[#334155] text-base leading-7 mb-4">新加坡烟草相关税负主要包括烟草消费税、关税和 GST。自2026年2月12日起，新加坡所有烟草产品消费税提高20%；下表为提高后的现行消费税率。</p>
        ...
        <TaxTableCard title="2. 关税 / 消费税计征方式">
          <p className="text-[#334155] text-base leading-7 mb-4">新加坡烟草产品属于应税货物，适用特定税率，不按统一百分比区间计征。非卷烟类烟草通常按重量计算；卷烟按支数及每支重量计算，且每支重量向上取整至最接近的克数。</p>
          <div className="overflow-x-auto rounded-xl border border-[#D8DDED]">
            <table className="w-full text-base min-w-[500px] bg-white">
              <thead>
                <tr className="bg-[#E8EDF5]">
        ...
        <TaxTableCard title="3. GST">
          <div className="space-y-2">
            <div className="flex items-start gap-2">
              <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
              <span className="text-[#334155] text-base leading-6">新加坡现行 GST 税率为 9%。</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
              <span className="text-[#334155] text-base leading-6">传统烟草产品在新加坡本地销售通常需缴纳 GST；进口烟草产品也需在进口环节缴纳 GST，计税基础通常包括货物价值、保险费、运费，以及适用的关税和消费税。</span>
            </div>
          </div>
        </TaxTableCard>
      </TaxSection>
      ...
      <SectionCard title="政策趋势分析">
        <div className="space-y-4">
          <p className="text-[#334155] text-base leading-7">新加坡烟草监管长期以控烟和公共健康保护为核心。传统烟草产品仍保留有限经营空间，但监管重点是减少展示、减少宣传、提高税负，并通过禁烟场所规则限制使用场景。电子烟、HNB烟支、尼古丁袋、雾化器等新型产品则继续采取原则禁止和严格执法的路径。</p>
          <p className="text-[#334155] text-base leading-7">2026年的修法进一步强化了这一方向。监管已经从传统的进口、销售和广告控制，延伸到购买、持有、使用、储存、场所责任、雾化器组件、仿烟产品以及含特定精神活性物质产品。</p>
          <p className="text-[#334155] text-base leading-7">未来新加坡大概率仍将维持&ldquo;传统烟草产品有限准入、新型产品原则禁止、个人和场所责任同步强化&rdquo;的监管格局。</p>
        </div>
      </SectionCard>
