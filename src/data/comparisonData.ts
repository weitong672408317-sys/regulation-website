...
export const countryOverviewData: CountryOverviewEntry[] = [
  ...
  },
  {
    ...
    productAccessSummary: [
      { color: 'green', status: '可准入', products: ['传统烟草', 'HNB', '电子烟', '无烟烟草', '烟草原料', '爆珠等普通辅材（不含烟草、尼古丁或烟草提取物）'] },
  ...
  },
  {
    ...
    productAccessSummary: [
      { color: 'green', status: '可准入', products: ['传统烟草', '电子烟及雾化产品', 'HNB', '烟草原料', '爆珠等普通辅材（不含烟草、尼古丁或烟草提取物）'] },
  ...
  },
  {
    ...
    productAccessSummary: [
      { color: 'green', status: '可准入', products: ['烟草材料', '燃烧类烟草', '电子烟', 'HNB', '无烟草尼古丁袋', '爆珠等普通辅材（不含烟草、尼古丁或烟草提取物）'] },
  ...
  },
  {
    ...
    productAccessSummary: [
      { color: 'green', status: '可准入', products: ['爆珠等普通辅材（不含烟草、尼古丁或烟草提取物）'] },
      { color: 'amber', status: '可准入，但严格监管', products: ['烟草及尼古丁原料', '传统烟草', '大部分无烟烟草产品', 'HNB', '电子烟及液体产品'] },
  ...
  },
  {
    ...
    productAccessSummary: [
      { color: 'green', status: '可准入', products: ['传统烟草', 'HNB', '烟草原料', '爆珠等普通辅材（不含烟草、尼古丁或烟草提取物）'] },
