      ...
      <section className="mb-8">
        <div className="bg-white border border-[#D4DAEA] rounded-2xl shadow-sm p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#F0F7F2] border border-[#BFDCC7] border-l-4 border-l-[#6AAF7C] rounded-xl p-5">
              <h3 className="text-lg font-bold text-[#3D7050] mb-4">可合规准入</h3>
              <div className="space-y-4">

                <div className="bg-white border border-[#E2E6EF] rounded-xl p-5">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-[#2E3F73] text-lg">传统烟草产品/烟草基产品</h3>
                    <span className="px-3 py-1 rounded-full text-sm font-semibold bg-[#E8F5ED] text-[#3D7050]">可合规准入</span>
                  </div>
                  <div className="mb-4">
                    <p className="font-semibold text-[#1F2A44] text-base mb-2">产品定性</p>
                ...
                <div className="bg-white border border-[#E2E6EF] rounded-xl p-5">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-[#2E3F73] text-lg">电子烟及雾化产品</h3>
                    <span className="px-3 py-1 rounded-full text-sm font-semibold bg-[#E8F5ED] text-[#3D7050]">可合规准入</span>
                  </div>
                  <div className="mb-4">
                    <p className="font-semibold text-[#1F2A44] text-base mb-2">产品定性</p>
                ...
                <div className="bg-white border border-[#E2E6EF] rounded-xl p-5">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-[#2E3F73] text-lg">HNB烟支及加热装置</h3>
                    <span className="px-3 py-1 rounded-full text-sm font-semibold bg-[#E8F5ED] text-[#3D7050]">可合规准入</span>
                  </div>
                  <div className="mb-4">
                    <p className="font-semibold text-[#1F2A44] text-base mb-2">产品定性</p>
                ...
                <div className="bg-white border border-[#E2E6EF] rounded-xl p-5">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-[#2E3F73] text-lg">烟草原料及普通辅材</h3>
                    <span className="px-3 py-1 rounded-full text-sm font-semibold bg-[#E8F5ED] text-[#3D7050]">可合规准入</span>
                  </div>
                  <div className="mb-4">
                    <p className="font-semibold text-[#1F2A44] text-base mb-2">产品定性</p>
            ...
            <div className="bg-[#FDF8EE] border border-[#E8D7BE] border-l-4 border-l-[#C9A24C] rounded-xl p-5">
              <h3 className="text-lg font-bold text-[#8B6F2E] mb-4">部分限制 / 需确认</h3>
              <div className="space-y-4">

                <div className="bg-white border border-[#E2E6EF] rounded-xl p-5">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-bold text-[#2E3F73] text-lg">口含、鼻吸及其他非燃烧型产品</h3>
          ...
          <div className="space-y-4">
            <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-[#D8DDED]">
                  <a href="https://dinavisa.gov.py/wp-content/uploads/2025/08/DECRETO-N%C2%B0-7605-2017-Regula-las-actividades-relacionadas-al-tabaco.pdf" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base hover:underline block mb-1">《第7605/2017号法令：关于实施第5538/2015号法若干条款的法令》</a>
                  <p className="text-sm text-[#334155] leading-6">第5538/2015号法的主要实施法令，细化烟草包装健康警示、无烟环境、广告促销、销售限制和监管执行等要求。</p>
                </div>
                <div className="pt-4 border-t border-[#D8DDED]">
                  <a href="https://assets.tobaccocontrollaws.org/uploads/legislation/Paraguay/Paraguay-Decree-No.-46242020-native.pdf" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base hover:underline block mb-1">《第4624/2020号法令：关于修改第7605/2017号法令第3条的法令》</a>
            ...
            <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-[#D8DDED]">
                  <a href="https://www.mspbs.gov.py/dependencias/dnvs/adjunto/843cb0-ResolucionDNVSN1531.pdf" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base hover:underline block mb-1">《国家卫生监督局第153/2021号决议：关于电子烟、雾化器、电子尼古丁输送系统、无尼古丁类似系统及相关使用物质的产品登记和经营场所授权要求的决议》</a>
            ...
            <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
              <h3 className="text-lg font-bold text-[#2E3F73] mb-4">DINAVISA 注册与产品资料</h3>
              <div className="space-y-4">
                <div>
                  <a href="https://dinavisa.gov.py/productos-a-base-de-tabaco-tb/" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base hover:underline block mb-1">DINAVISA：烟草基产品（Productos a Base de Tabaco – TB）</a>
                ...
                <div className="pt-4 border-t border-[#D8DDED]">
                  <a href="https://dinavisa.gov.py/wp-content/uploads/2024/04/Proyecto-de-Resolucion-Bolsas-de-Nicotina.docx" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base hover:underline block mb-1">DINAVISA：尼古丁袋专项注册规则草案</a>
            ...
            <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
              <h3 className="text-lg font-bold text-[#2E3F73] mb-4">税务与商品归类资料</h3>
              <div>
                <a href="https://www.dnit.gov.py/web/portal-institucional/dictamenes-de-clasificacion" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base hover:underline block mb-1">DNIT：商品归类数据库</a>
            ...
            <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
              ...
              <div className="space-y-4">
                <div>
                  <a href="https://dinavisa.gov.py/alerta-sanitaria-n-12-2023/" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base hover:underline block mb-1">DINAVISA：未注册电子烟产品卫生警示</a>
                  <p className="text-sm text-[#334155] leading-6">DINAVISA 针对未注册或来源不明电子烟产品发布卫生警示，体现主管机关对电子烟产品注册、来源可追溯和授权销售场所的监管关注。</p>
                </div>
                <div className="pt-4 border-t border-[#D8DDED]">
                  <a href="https://www.mspbs.gov.py/portal/25515/exigiran-inscripcion-de-cigarrillos-electronicos-y-vapeadores-para-su-importacion.html" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base hover:underline block mb-1">MSPBS：电子烟和雾化器进口登记要求说明</a>
                ...
                <div className="pt-4 border-t border-[#D8DDED]">
                  <a href="https://www.vouga.com.py/novedades-impositivas-agosto-2025/" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#243B63] text-base hover:underline block mb-1">Vouga Abogados：2025年税务动态</a>
