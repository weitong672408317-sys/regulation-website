    ...
    <CountryPageTemplate>
        ...
        cards={[
          {
            ...
            content: (
              <>
                <p className="text-base leading-7 text-justify text-[#334155] mb-4">新加坡采取&ldquo;传统烟草产品从严管控、新型烟草及尼古丁产品明确禁入、烟草使用空间高度受限&rdquo;的监管模式。</p>
                <BulletList items={[
          ...
          },
          {
            title: '监管部门',
            content: (
              <ul className="list-disc pl-5 space-y-3 text-base leading-7 text-justify text-[#334155]">
      ...
      <ProductAccessSection>
        ...
        <ProductModuleCard title="1. 传统烟草产品及烟草材料" label="产品定性">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            <StatusCard
              ...
              title="1.1 传统烟草成品"
              content={<>
                <div className="text-base text-justify text-[#334155] mb-2">适用产品：传统卷烟、雪茄、小雪茄、其他制成烟草等。</div>
                <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                <ul className="space-y-1 text-[#334155] text-justify leading-7">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-2 flex-shrink-0"></span>
                    <span>传统烟草成品可以在新加坡依法经营，但进口、批发、分销和零售均需取得对应烟草许可证。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-2 flex-shrink-0"></span>
                    <span>烟草许可证按经营环节和具体门店管理，不能在不同经营活动、不同公司或不同门店之间通用。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-2 flex-shrink-0"></span>
                    <span>进口或本地制造传统烟草成品，均需按规定缴纳消费税；卷烟、雪茄、小雪茄及其他制成烟草的消费税已提高至每支58.9新分。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-2 flex-shrink-0"></span>
                    <span>本地销售应符合 HSA 烟草零售监管要求，并遵守标准化包装、健康警示、标签、销售对象、展示、广告和促销限制。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-2 flex-shrink-0"></span>
                    <span>传统烟草产品的使用地点受到严格限制，室内公共场所、工作场所、公共交通、餐饮娱乐及部分户外区域均可能属于禁烟范围。</span>
                  </li>
                </ul>
              </>}
            />
            <StatusCard
              status="amber"
              customLabel="需按申报品名、加工程度和最终用途确认"
              title="1.2 烟草材料 / 原料"
              content={<>
                <div className="text-base text-justify text-[#334155] mb-2">适用产品：未加工烟草、切丝烟草、烟草废料、烟叶、烟草薄片等。</div>
                <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                <ul className="space-y-1 text-[#334155] text-justify leading-7">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-2 flex-shrink-0"></span>
                    <span>未加工烟草、切丝烟草、烟草废料等属于烟草产品监管和消费税关注范围，进口前应确认烟草许可证、海关申报、消费税和完税要求。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-2 flex-shrink-0"></span>
                    <span>已经构成传统卷烟、雪茄、小雪茄或其他制成烟草的，应按传统烟草成品路径处理。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-2 flex-shrink-0"></span>
                    <span>已经制成或包装为 HNB烟支、加热烟草产品、口含烟、可溶性烟草或其他禁止类产品的，不得按普通烟草原料路径进入新加坡市场。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-2 flex-shrink-0"></span>
                    <span>烟草材料进口申报时，应准确说明申报品名、加工程度、成分、用途和最终产品形态。</span>
                  </li>
                </ul>
              </>}
            />
        ...
        <ProductModuleCard title="2. 新型烟草、尼古丁及其他禁止类产品" label="产品定性">
          <ul className="space-y-2 pl-5 list-disc text-base leading-7 text-justify text-[#334155] mb-4">
            <li>新加坡对新型烟草、尼古丁及相关替代类产品采取明确禁入规则。禁止范围不只限于电子烟，也包括加热烟草、无烟及口含类产品、仿烟产品和相关组件。</li>
          </ul>
          <div className="space-y-4">
            <StatusCard
              status="red"
              title="2.1 加热烟草、电子雾化及相关组件"
              content={<>
                <div className="text-base text-justify text-[#334155] mb-2">适用产品：HNB烟支、加热烟草产品、加热设备、电子烟、雾化器、烟油、烟弹、补充液及相关组件。</div>
                <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                <ul className="space-y-1 text-[#334155] text-justify leading-7">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#DC6B6B] mt-2 flex-shrink-0"></span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#DC6B6B] mt-2 flex-shrink-0"></span>
                    <span>相关设备、组件、烟弹、烟油、补充液不得拆分申报或按普通电子产品、普通液体、普通样品处理。</span>
                  </li>
                </ul>
              </>}
            />
            <StatusCard
              status="red"
              title="2.2 无烟、口含及其他非燃烧类产品"
              content={<>
                <div className="text-base text-justify text-[#334155] mb-2">适用产品：尼古丁袋、尼古丁口含膜、口含烟、鼻烟、snus、可溶性烟草或尼古丁、嚼烟，以及 Gutkha、Khaini、Zarda 等南亚常见口含 / 咀嚼类烟草制品。</div>
                ...
                <ul className="space-y-1 text-[#334155] text-justify leading-7">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#DC6B6B] mt-2 flex-shrink-0"></span>
                    <span>不得按传统烟草产品、普通食品、普通口含产品、个人用品或样品方式进入新加坡市场。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#DC6B6B] mt-2 flex-shrink-0"></span>
                    <span>含烟草或尼古丁，并通过口含、鼻吸、咀嚼、溶解等方式使用的产品，应按禁止类产品处理。</span>
                  </li>
                </ul>
              </>}
            />
            <StatusCard
              ...
              title="2.3 仿烟产品及相关组件"
              content={<>
                <div className="text-base text-justify text-[#334155] mb-2">适用产品：模仿烟草产品、电子烟或吸烟行为的产品、装置、食品或相关组件。</div>
                <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                <ul className="space-y-1 text-[#334155] text-justify leading-7">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#DC6B6B] mt-2 flex-shrink-0"></span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#DC6B6B] mt-2 flex-shrink-0"></span>
                    <span>仿烟产品的判断不只看是否含烟草或尼古丁，也要看外观、功能、使用方式和是否模仿吸烟行为。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#DC6B6B] mt-2 flex-shrink-0"></span>
                    <span>不得通过玩具、食品、装置、配件、样品或展示品等形式规避禁止类产品监管。</span>
                  </li>
                </ul>
              </>}
            />
        ...
        {/* 3. 爆珠、香精胶囊、滤嘴棒等辅料 */}
        <ProductModuleCard title="3. 爆珠、香精胶囊、滤嘴棒等辅料" label="产品定性">
          <ul className="space-y-2 pl-5 list-disc text-base leading-7 text-justify text-[#334155] mb-4">
            <li>新加坡公开资料未见对爆珠、香精胶囊、滤嘴棒设置统一、单独的产品定义。该类产品应结合成分、形态、进口申报品名和产品功能判断。</li>
          </ul>
          <div className="grid md:grid-cols-2 gap-4">
            <StatusCard
              status="green"
              customLabel="可准入，但需按成分和产品功能确认"
              title="3.1 爆珠、香精胶囊"
              content={<>
                <div className="text-base text-justify text-[#334155] mb-2">适用产品：爆珠、香精胶囊。</div>
                <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                <ul className="space-y-1 text-[#334155] text-justify leading-7">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-2 flex-shrink-0"></span>
                    <span>不含尼古丁、烟草或烟草提取物的爆珠、香精胶囊，一般可按普通货物路径判断。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-2 flex-shrink-0"></span>
                    <span>如含有尼古丁、烟草或烟草提取物，应重新判断是否触发烟草产品、禁止类产品、毒物 / 药品或其他专项监管要求。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-2 flex-shrink-0"></span>
                    <span>进口申报时应准确说明产品成分、形态和功能；如产品本身构成雾化器组件、仿烟产品或其他受管制物品，应按相应监管路径处理。</span>
                  </li>
                </ul>
              </>}
            />
            <StatusCard
              status="green"
              customLabel="可准入，但需按成分和产品功能确认"
              title="3.2 滤嘴棒等其他不含烟草 / 尼古丁的辅料"
              content={<>
                <div className="text-base text-justify text-[#334155] mb-2">适用产品：滤嘴棒等不含烟草、不含尼古丁的辅料。</div>
                <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                <ul className="space-y-1 text-[#334155] text-justify leading-7">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-2 flex-shrink-0"></span>
                    <span>不含烟草、尼古丁或烟草提取物的滤嘴棒等普通辅料，公开资料未见单独禁令。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-2 flex-shrink-0"></span>
                    <span>如含有尼古丁、烟草或烟草提取物，应重新判断是否触发烟草产品、消费税、毒物 / 药品或其他专项监管要求。</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-2 flex-shrink-0"></span>
                    <span>进口申报时应准确说明产品成分、形态和功能；如产品本身构成雾化器组件、仿烟产品或其他受管制物品，应按相应监管路径处理。</span>
        ...
        <div className="space-y-4">
          <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
            ...
            <div className="ml-9 space-y-2">
              <div className="flex items-start gap-2">
                ...
                <span className="text-[#334155] text-base leading-7 text-justify">适用于进口、批发和分销传统烟草产品的经营活动。</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-7 text-justify">进口、批发或分销烟草产品前，应取得 HSA 烟草进口商和批发商许可证。</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-7 text-justify">申请通常需要提交经营主体、仓库或办公场所、生产商授权等资料，许可管理与具体经营安排相关。</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
            ...
            <div className="ml-9 space-y-2">
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-7 text-justify">适用于在新加坡本地零售传统烟草产品的门店。</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-7 text-justify">烟草零售许可证按具体门店发放，经营多个门店的，应分别申请。</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-7 text-justify">零售许可证不得在不同公司或不同门店之间转让。</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
            ...
            <div className="ml-9 space-y-2">
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-7 text-justify">新加坡法规对部分禁止类产品设有有限豁免，涉及部分 smokeless tobacco product（无烟烟草产品）、vaporiser solution（雾化器溶液）、vaporiser（雾化器）、exempt imitation tobacco product（豁免仿烟产品）及其组件。</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-7 text-justify">法规列明的豁免目的包括 non-clinical research（非临床研究）、product development（产品开发）和 supply-chain related activity（供应链相关活动）。</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-7 text-justify">supply-chain related activity（供应链相关活动）在法规中指产品及组件的移动和储存，包括组件采购、供应商管理、生产排期、库存和仓库管理、进出口贸易合规、分销及相关支持活动。</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-7 text-justify">上述供应链相关活动只是在豁免令下用于判断&ldquo;豁免目的&rdquo;的范围。相关产品是否可以进口、持有、移动或储存，还需要继续满足豁免令对产品类型、行为类型、主体、通知、记录、储存和期限等条件的要求。</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                <span className="text-[#334155] text-base leading-7 text-justify">该等豁免不等同于新加坡本地消费市场准入，不能作为本地销售、递样、展示、推广或消费者使用的依据。</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <TaxSection>
        <TaxTableCard title="1. 烟草消费税">
          <p className="text-[#334155] text-base leading-7 text-justify mb-4">新加坡烟草相关税负主要包括烟草消费税、关税和 GST。自2026年2月12日起，新加坡所有烟草产品消费税提高20%；下表为提高后的现行消费税率。</p>
        ...
        <TaxTableCard title="2. 关税 / 消费税计征方式">
          <p className="text-[#334155] text-base leading-7 text-justify mb-4">新加坡烟草产品属于应税货物，适用特定税率，不按统一百分比区间计征。非卷烟类烟草通常按重量计算；卷烟按支数及每支重量计算，且每支重量向上取整至最接近的克数。</p>
          <div className="overflow-x-auto rounded-xl border border-[#D8DDED]">
            <table className="w-full text-base min-w-[500px] bg-white">
              <thead>
                <tr className="bg-[#E8EDF5]">
        ...
        <TaxTableCard title="3. GST">
          <div className="space-y-2">
            <div className="flex items-start gap-2">
              <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
              <span className="text-[#334155] text-base leading-7 text-justify">新加坡现行 GST 税率为 9%。</span>
            </div>
            <div className="flex items-start gap-2">
              <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
              <span className="text-[#334155] text-base leading-7 text-justify">传统烟草产品在新加坡本地销售通常需缴纳 GST；进口烟草产品也需在进口环节缴纳 GST，计税基础通常包括货物价值、保险费、运费，以及适用的关税和消费税。</span>
            </div>
          </div>
        </TaxTableCard>
      </TaxSection>
      ...
      <SectionCard title="政策趋势分析">
        <div className="space-y-4">
          <p className="text-[#334155] text-base leading-7 text-justify">新加坡烟草监管长期以控烟和公共健康保护为核心。传统烟草产品仍保留有限经营空间，但监管重点是减少展示、减少宣传、提高税负，并通过禁烟场所规则限制使用场景。电子烟、HNB烟支、尼古丁袋、雾化器等新型产品则继续采取原则禁止和严格执法的路径。</p>
          <p className="text-[#334155] text-base leading-7 text-justify">2026年的修法进一步强化了这一方向。监管已经从传统的进口、销售和广告控制，延伸到购买、持有、使用、储存、场所责任、雾化器组件、仿烟产品以及含特定精神活性物质产品。</p>
          <p className="text-[#334155] text-base leading-7 text-justify">未来新加坡大概率仍将维持&ldquo;传统烟草产品有限准入、新型产品原则禁止、个人和场所责任同步强化&rdquo;的监管格局。</p>
        </div>
      </SectionCard>

      {/* 合规红线清单 */}
      <SectionCard title="合规红线清单">
        <RedLineBox groups={[
          {
            title: '禁止类产品',
            items: [
              '严禁将电子烟、雾化器、烟油、HNB烟支、尼古丁袋、水烟烟草、仿烟产品及相关设备或组件进口、销售、供应、购买、持有或使用。',
