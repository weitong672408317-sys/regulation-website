  ...
  return (
    <CountryPageTemplate>
      ...
      <ComplianceSection country={country}>
        <p className="text-[#334155] text-base leading-7 mb-6">阿联酋烟草及新型烟草产品的合规重点，不在于一般公司设立资质，而在于产品认证、行业许可、税务税票和地方销售许可。</p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
            ...
            <p className="ml-6 text-[#334155] text-base leading-7 mb-3">烟草产品（包括电子烟）、无烟草尼古丁袋等受管制产品进入阿联酋市场前，必须依法取得由政府认可的产品符合性证书（Certificate of Conformity, CoC）。</p>
          ...
          <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
            ...
            <p className="ml-6 text-[#334155] text-base leading-7 mb-3">ECAS（Emirates Conformity Assessment Scheme）是一套强制性产品认证机制，用于检验产品是否符合阿联酋法律和技术标准。</p>
            <div className="ml-6">
              <div className="flex items-center gap-2 mb-1.5">
                <span className="w-1.5 h-1.5 rotate-45 bg-[#6B7FA6] rounded-[1px] flex-shrink-0"></span>
        ...
        <TaxTableCard title="主要税种">
          ...
          <div className="overflow-x-auto rounded-xl border border-[#D8DDED]">
            <table className="w-full text-base min-w-[800px] bg-white">
              <thead>
                <tr className="bg-[#E8EDF5]">
                  <th className="px-4 py-4 text-left font-bold text-[#2E3F73] border-b-2 border-r border-[#D8DDED] w-[12%]">税种</th>
                  <th className="px-4 py-4 text-left font-bold text-[#2E3F73] border-b-2 border-r border-[#D8DDED] w-[38%]">适用对象 / 范围</th>
                  <th className="px-4 py-4 text-left font-bold text-[#2E3F73] border-b-2 border-r border-[#D8DDED] w-[18%]">税率</th>
                  <th className="px-4 py-4 text-left font-bold text-[#2E3F73] border-b-2 border-[#D8DDED] w-[32%]">注册要求及门槛</th>
                </tr>
              </thead>
              <tbody>
