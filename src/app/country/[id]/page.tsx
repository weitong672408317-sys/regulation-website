...
export default function CountryDetail() {
  ...
  const isRussiaStyle = country?.id === 'russia' || country?.id === 'uae' || country?.id === 'paraguay';
  ...
  return (
    <div className="min-h-screen bg-[#F7F9FC]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {(country.id === 'russia' || country.id === 'uae' || country.id === 'paraguay') && (
          <section className="mb-8">
            <div className="bg-white border border-[#D4DAEA] rounded-2xl shadow-sm p-6">
              ...
              <div className="space-y-4">
                <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
                  <p className="text-[#334155] text-base leading-7">巴拉圭暂无明确全国性全面禁止品类。</p>
                </div>

                <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
                  <h3 className="text-lg font-bold text-[#2E3F73] mb-4">1. 传统烟草</h3>
                  <StatusCard
                    status="green"
                    title="传统卷烟、雪茄、加工烟草"
                    content={<>
                      ...
                      <ul className="space-y-1 text-[#334155]">
                        <li className="flex items-start gap-2">
                          ...
                          <span>可准入。烟草基产品需要办理 DINAVISA 产品登记，登记结果体现为烟草产品证书或按品种产品登记证明。</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                ...
                <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
                  ...
                  <StatusCard
                    status="green"
                    title="电子烟 / 雾化器 / 一次性电子烟 / 烟油 / 烟弹 / 胶囊 / 配件 / 耗材"
                    content={<>
                      <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                      <ul className="space-y-1 text-[#334155]">
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                          <span>可准入。相关产品需要完成 DINAVISA 产品注册和经营场所授权。</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                ...
                <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
                  <h3 className="text-lg font-bold text-[#2E3F73] mb-4">3. HNB烟支及加热烟草产品</h3>
                  <StatusCard
                    status="green"
                    title="HNB烟支 / 加热烟草产品 / HNB设备及配件"
                    content={<>
                      <div className="font-semibold text-[#263247] mb-1">主要合规要点：</div>
                      <ul className="space-y-1 text-[#334155]">
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                          <span>可准入。含烟草的 HNB烟支需要符合烟草产品包装、税务、销售和公共场所使用规则。</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#6AAF7C] mt-1.5 flex-shrink-0"></span>
                ...
                <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
                  <h3 className="text-lg font-bold text-[#2E3F73] mb-4">4. 尼古丁袋 / 尼古丁口含膜</h3>
                  <StatusCard
                    status="amber"
                    title="尼古丁袋 / 尼古丁口含膜"
                    customLabel="需确认"
                    content={<>
                      ...
                      <ul className="space-y-1 text-[#334155]">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
                          <span>DINAVISA 已经关注该类产品的卫生注册，DNIT 也已有无烟草尼古丁袋商品归类实践。</span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#C9A24C] mt-1.5 flex-shrink-0"></span>
                          <span>实际进口和销售前，需要先确认是否可以取得卫生注册、是否需要经营场所授权、适用尼古丁含量和标签要求，以及进口税务口径。</span>
                        </li>
                      </ul>
                    </>}
                  />
        ...
        <section className="mb-8">
          <div className={isRussiaStyle ? "bg-white border border-[#D4DAEA] rounded-2xl shadow-sm p-6" : "bg-white rounded-xl shadow-md border border-gray-200 p-6"}>
            ...
            {country.id === 'russia' ? (
              ...
              <div className="space-y-4">
                {parseOverview(country.regulatorySystem.overview).filter(section => section.title !== '主要产品口径').map((section, index) => (
                  <div key={index} className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <ul className="space-y-3">
                      ...
                      <li className="text-[#334155] text-base leading-7 flex items-start gap-3">
                        <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-[#4A6290] flex-shrink-0"></span>
                        <span className="md:whitespace-nowrap">不得在距清真寺100米、学校150米范围内开设烟草销售点或水烟提供场所</span>
                      </li>
                    </ul>
                  </div>
            ...
            {country.id === 'uae' ? (
              <div className="space-y-4">
                <div className="bg-[#F3F5FB] border border-[#D8DDED] rounded-xl p-5">
                  ...
                  <p className="text-[#334155] text-base leading-7 mb-4">阿联酋烟草及新型烟草产品监管预计会继续沿着"合法市场内强合规管理"的方向发展。传统卷烟、水烟烟草、HNB烟支、电子烟及烟油等产品短期内出现全国性全面禁令的可能性较低，监管重点更可能继续集中在产品认证、消费税、数字税票、进口清关、地方销售许可和广告促销限制。</p>
                  <p className="text-[#334155] text-base leading-7 mb-4">新型尼古丁产品的监管边界会进一步细化。无烟草尼古丁袋已经通过 UAE.S 5061:2025 建立技术监管基础，说明阿联酋对部分新型尼古丁产品更倾向于设置标准后纳入合规市场；但尼古丁口含膜、尼古丁片、尼古丁粉末、鼻吸尼古丁产品等非袋状产品，仍需要结合产品形态、成分和主管机关口径确认是否具备稳定准入路径。</p>
                  <p className="text-[#334155] text-base leading-7">自由区仍会是烟草、电子烟、尼古丁产品及相关原辅材进出口、仓储和转口的重要场景，但自由区安排不会当然解决阿联酋大陆市场销售问题。产品从自由区进入本地市场时，仍需重新关注产品认证、消费税、数字税票、地方销售许可和销售端限制。</p>
                </div>
        ...
        <section className="mb-8">
          <div className={isRussiaStyle ? "bg-white border border-[#D4DAEA] rounded-2xl shadow-sm p-6" : "bg-white rounded-xl shadow-md border border-gray-200 p-6"}>
            ...
            {country.id !== 'uae' && country.id !== 'paraguay' && (
