...
const fallbackCountries: CountryData[] = [
  ...
  },
  {
    ...
    regulatorySystem: {
      overview: '**核心特征**\n\n香港烟草监管以公共健康、控烟管理和打击非法烟草流通为主要政策背景。整体监管强度较高，传统烟草、新型吸入类产品、无烟烟草产品及含尼古丁产品分别适用不同监管路径：\n\n• 传统烟草：仍保留有限合法空间，但受到高烟草税、完税管理、包装警示、广告限制、禁烟场所和私烟执法等规则约束。\n• 另类吸烟产品：原则上不得进口、制造、售卖、推广及为商业目的管有。\n• 无烟烟草产品：原则上不得输入、制造、售卖、为出售而管有、要约出售、为出售而展示、托付或交付。\n• 不含烟草但含尼古丁的口含类产品：需按毒药及药剂制品规则进一步判断，不能按普通消费品处理。\n\n**监管部门**\n\n香港烟草监管由多个部门共同执行，分工如下：\n\n• 卫生署控烟酒办公室：负责控烟政策、禁烟场所和另类吸烟产品禁令。\n• 香港海关：负责应课税品、烟草税、完税管理、私烟执法及边境执法。\n• 食物环境卫生署/食物安全中心：负责无烟烟草产品禁令相关执法。\n• 卫生署药物办公室/药剂业及毒药管理局：负责毒药及药剂制品监管。',
